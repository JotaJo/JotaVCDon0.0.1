...
Base = 'http://jotavcdon.blogspot.com.es/p/nueva.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.JotaVCDon 0.0.1') #    modificar("el nombre de tu addons")
